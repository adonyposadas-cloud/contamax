...
(function () {
  ...
  window.fiscExportar = () => {
    ...
    XLSX.utils.book_append_sheet(wb, XLSX.utils.aoa_to_sheet(comprasCostoAoA), 'Compras Costos')
    XLSX.utils.book_append_sheet(wb, XLSX.utils.aoa_to_sheet(comprasGastoAoA), 'Compras Gastos')
