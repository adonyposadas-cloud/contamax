...
(() => {
  ...
  function renderResultado() {
    ...
    const avisoRango = e.rangoAmpliado ? `<div style="padding:9px 14px;border-radius:9px;margin-bottom:10px;background:rgba(59,130,246,.10);border:1px solid var(--blue,#3b82f6);color:#9ec5fe;font-size:12.5px">
